...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def process_request(self, request, spider):
        request_user_agent = self._get_random_user_agent()
        request.headers['User-Agent'] = request_user_agent

        print(' New User Agents Attched '.center(150, '-'))
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def process_request(self, request, spider):
        ...
        print(' New Headers Attched '.center(150, '-'))
